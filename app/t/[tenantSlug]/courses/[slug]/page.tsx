...
export default async function TenantCoursePage({ params }: PageProps) {
  ...
  try {
    ...
    const course = await getCourseBySlug(tenant.id, slug);
    ...
    const canEnroll = canEnrollViaPurchase(tenant.enrollmentMode);
    ...
    return (
      <AppShell title={course.title} tenant={{ name: tenant.name, slug: tenant.slug, logoUrl: tenant.logoUrl, logoDarkUrl: tenant.logoDarkUrl, primaryColor: tenant.primaryColor }}>
          ...
          <div className="space-y-8">
            ...
            {enrolled && (
              <section className="space-y-4">
                ...
                <form
                  action={submitReviewAction.bind(null, tenantSlug)}
